...
* **Ground-truth Mapping (`dataset_pairs.csv`):** Instead of labeling individual files, we strictly evaluate **File Pairs**. The dataset comprises **1350 pairs**, mapped as:
...
The system was benchmarked against the 1350 file pairs using $k = 10$, $w = 5$, and a Similarity Threshold of $T = 60\%$.
* **Total Pairs Evaluated:** 1350
* **Accuracy:** `[Insert %]`
